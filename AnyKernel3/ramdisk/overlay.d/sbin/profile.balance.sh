...
echo "0" > /sys/devices/system/cpu/cpu4/cpufreq/PIXEL_SMURFUTIL/hispeed_freq
...
echo "500" > /sys/devices/system/cpu/cpu4/cpufreq/PIXEL_SMURFUTIL/up_rate_limit_us
...
# Profile Log
dt=`date '+%d/%m/%Y %H:%M:%S'`
echo "$dt Balanced LRK-P applied" >> /storage/emulated/0/LawRun-Kernel/log.txt
